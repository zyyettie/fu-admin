<template>
  <div>
    ...
    <DiagimDrawer @register="registerDrawer" @success="handleSuccess" />
  </div>
</template>
<script lang="ts">
...
import DiagimDrawer from './Drawer.vue';
...
export default defineComponent({
  name: 'Diagim',
  components: { BasicTable, DiagimDrawer, TableAction, BasicUpload, Space },
  setup() {
